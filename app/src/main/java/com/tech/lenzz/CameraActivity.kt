...
import com.tech.lenzz.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
        ...
        cameraProviderFuture.addListener(
            Runnable {
                ...
                val preview = Preview.Builder()
                    .build()
                    .also {
                        it.setSurfaceProvider(cameraBinding.previewView.surfaceProvider) //changed createSurfaceProvider()
                    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cameraBinding.btnTakePhoto.setOnClickListener { takePhoto() }
